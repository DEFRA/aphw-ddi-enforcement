...
const allowableTasks = [
  tasks.applicationPackSent,
  tasks.insuranceDetailsRecorded,
  tasks.microchipNumberRecorded,
  tasks.applicationFeePaid,
  tasks.form2Sent
]
...
const mapManageCdoDetails = (details, cdo) => {
  ...
  taskNames.forEach(name => {
    if (allowableTasks.includes(name)) {
