/**
 * @param {Partial<CdoDtoExemption>} exemptionPartial
 * @returns {CdoDtoExemption}
 */
...
/**
 * @param {Partial<CdoDtoPerson>} personPartial
 * @returns {CdoDtoPerson}
 */
...
/**
 * @param {Partial<CdoDog>} dogPartial
 * @returns {CdoDog}
 */
const buildDog = (dogPartial = {}) => ({
  name: 'Mithril',
  breed: 'XL Bully',
  colour: 'Azure',
  dateExported: null,
