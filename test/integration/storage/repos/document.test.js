describe('document template repo', () => {
  ...
  test('should throw error if exemption template does not exist', async () => {
    ...
    await expect(downloadDocument('ED1234', 'fbab4d37-9614-4db1-b66a-1b562f69ba4d')).rejects.toThrow('Certificate \'ED1234/fbab4d37-9614-4db1-b66a-1b562f69ba4d.pdf\' does not exist')
  })
})
